...
export const Config = z.object({
  ...
  /**
   * Publish the ten `browser_embedded_*` tools only after the `browser-use`
      ...
      () =>
        promptCtx.systemPrompt.section({
          ...
          text:
            ...
            + 'load the browser-use skill first: it routes browser work and is what publishes the browser_embedded_* tools. '
